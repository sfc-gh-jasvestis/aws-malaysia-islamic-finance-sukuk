...
export default function HomePage() {
  ...
  const domainTab1 = (
    <div className="space-y-6">
      ...
      <Chart
        ...
        title="Finance Sukuk Performance Trend"
        height={400}
      />
    </div>
  );
  ...
  const domainTab2 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        />
        <ActionMemo
          persona={{ name: 'Malaysia Operations Lead', role: 'Director of Finance Sukuk' }}
          context={{}}
          onGenerate={async () => ({
            subject: 'Action Required',
            body: 'AI-generated recommendation based on current data patterns and predicted trends.',
            urgency: 'HIGH',
            actions: ['Review top compliance findings', 'Optimize product allocation', 'Prepare quarterly finance sukuk report'],
          })}
        />
      </div>
    </div>
  ...
  const tabs = [
    ...
    { id: 'domain-1', label: 'Finance Sukuk Analytics', icon: '📈', content: domainTab1 },
