...
CREATE OR REPLACE STORAGE INTEGRATION aws_malaysia_islamic_finance_sukuk_S3_INT
  ...
  ENABLED = TRUE
  STORAGE_ALLOWED_LOCATIONS = ('s3://<YOUR_S3_BUCKET>/aws-malaysia-islamic-finance-sukuk/');
...
CREATE OR REPLACE STAGE RAW.LANDING_STAGE
  ...
  URL = 's3://<YOUR_S3_BUCKET>/aws-malaysia-islamic-finance-sukuk/';

-- ==================== KINESIS / IOT CORE INGESTION ====================
-- Snowpipe from Kinesis Data Stream
-- Stream ARN: arn:aws:kinesis:ap-southeast-1:<YOUR_AWS_ACCOUNT_ID>:stream/aws-malaysia-islamic-finance-sukuk-stream
